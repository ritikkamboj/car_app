...
function Features() {
  return (
    <section className="border-2 border-blue-300  flexCenter bg-feature-bg bg-center bg-no-repeat py-24">
...
function Featuresitem({ title, icon, variant, description }: FeatureItems) {
  return (
