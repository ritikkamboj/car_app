...
function Camp() {
  return (
    <section className=" 2xl:max-container relative flex flex-col py-10 lg:py-20 mb-10 xl:mb-20">
      <div className="flex h-[340px] w-full items-start justify-start gap-8 lg:h-[400px] xl:h-[640px]  overflow-x-auto">
        <Campsite
