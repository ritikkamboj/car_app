...
function Hero() {
  return (
    <section className=" max-container padding-container flex flex-col gap-20 py-10 pb-32md:gap-28 lg:py-20 xl:flex-row ">
      ...
      <div className=" relative flex flex-1  items-start">
        <div className="w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            <div className="flexBetween">
              <p className="regular-16 text-gray-20">Location</p>
              <Image src="./close.svg" alt="close" height={24} width={24} />
            </div>
            <p className="bold-20 text-white">Aoolio Olio</p>
          </div>
          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular-16 text-gray-20">Distance</p>
              <p className="bold-20 text-white">173.28mil</p>
            </div>
            <div className="flex flex-col">
